			...
			<div class="body">
				...
				<form method="POST" action="{{ route('categorytype.store') }}" id="form_advanced_validation"
					...
					<div class="col-sm-12">
						...
						<div class="form-group">
							<div class="form-line">
								<textarea rows="10" name="html" class="ckeditor form-control no-resize"
									placeholder="Please type what you want..."></textarea>
							</div>
						</div>
					</div>
					{{-- <div class="form-group form-float">
                            <label for="body" class="form-label">Html</label>
                            <textarea  name="html" class="ckeditor form-control" id="tinymce" required>
                            </textarea>
					...
					<div class="col-sm-12">
						...
						<div class="form-group">
							<div class="form-line">
								<textarea rows="10" name="css" class="form-control no-resize ckeditor"
									placeholder="Please type what you want..."></textarea>
							</div>
						</div>
					</div>
					<div class="col-sm-12">
						...
						<div class="form-group">
							<div class="form-line">
								<textarea rows="10" name="javascript" class="form-control no-resize ckeditor"
									placeholder="Please type what you want..."></textarea>
							</div>
						</div>
					</div>
